...
-- | Parse a series of objects of type a, with single-character abbreviations.
-- The parser is generated by passing pFormats a Map of the abbreviations.
pFormats :: Ord a => Map Char a -> Parser (Set a)
pFormats abbrevs = S.fromList <$> do
  many $ choice $ map (\(k, v) -> v <$ char k) (M.assocs abbrevs)
